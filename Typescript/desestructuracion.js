...
(() => {
    ...
    const extraer = ({ nombre, sobrenombre, poder }) => {
    ...
    // extraer(bulldog);
    const bulldogs = ['Negro', 'Punki', 'Perro que se ahoga solo', 'Bulldog viejo aca la vuelta'];
    const extraerArreglo = ([deflor, deso, nn, nosabemos]) => {
        //desestructuración de objetos
